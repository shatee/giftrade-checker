...
var _canvasjs = __webpack_require__(2);
...
var _culture_info = __webpack_require__(8);
...
var _text_block = __webpack_require__(4);
...
var _data_series = __webpack_require__(9);
...
var _animator3 = __webpack_require__(1);
...
Chart.prototype._updateSize = function () {
	...
	if (this.canvas.width !== width * _utils.devicePixelBackingStoreRatio || this.canvas.height !== height * _utils.devicePixelBackingStoreRatio) {
...
Chart.prototype.render = function (options) {
	...
	if (animations.length > 0) {
		...
		_this._animator.animate(200, _this.animationDuration, function (fractionComplete) {
			...
			_this.ctx.drawImage(initialState, 0, 0, Math.floor(_this.width * _utils.devicePixelBackingStoreRatio), Math.floor(_this.height * _utils.devicePixelBackingStoreRatio), 0, 0, _this.width, _this.height);
